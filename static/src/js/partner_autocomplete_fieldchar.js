...
export class PartnerAutoCompleteCharField extends CharField {
    ...
    async onSelect(option) {
        ...
        if (this.props.record.resModel === 'customer.enq') {
...
PartnerAutoCompleteCharField.template = "zigma_erp.PartnerAutoCompleteCharField";
...
registry.category("fields").add("field_partner_zigma_autocomplete", partnerAutoCompleteCharField);
